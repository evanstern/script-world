...
- [x] T023 Re-ground: /grounding-wiki:wiki-update over touched notes (docs/wiki/executor.md, reflex-policy.md, sim-state-reducer.md, tool-registry.md), then player-docs freshness check (node .claude/skills/player-docs/scripts/check-freshness.mjs --check) and regenerate if stale
