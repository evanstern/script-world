...
- [x] T021 [P] Run quickstart §3–§6 live smoke on a throwaway world (local tier up); record observed situated lines, a conv transcript recovery, and any journal tool calls on the board task as evidence (run 2026-07-23 by the orchestrator: 12/12 memories carried where; [conv 516] transcript recovered from log alone; restart survival; post-T024, 5 reasoned intents landed live — evidence on TASK-16)
