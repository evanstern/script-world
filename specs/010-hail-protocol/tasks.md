...
- [X] T019 Live before/after measurement per quickstart.md on the baseline world shape (local tier, 8x): record "is gone" rejection count, conversation count, and hail met/expired mix on TASK-47 via `backlog task edit TASK-47 --append-notes` (SC-001, SC-002)
