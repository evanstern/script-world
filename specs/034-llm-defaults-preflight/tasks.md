...
- [ ] T008 Boot wiring: start the preflight goroutine (shutdown ctx, pattern `go sampler.run(ctx)` daemon.go:148) after llm.New inside the LLM-gated block in internal/daemon/daemon.go; boot must never block or fail on probe results (FR-002)
