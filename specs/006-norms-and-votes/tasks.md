...
- [x] T036 Wiki re-ground after merge-ready: new docs/wiki note for governance + re-verify notes whose sources changed (executor, social-fabric, agent-mind, chronicle, event-types) via /grounding-wiki:wiki-update
