...
type ClockStatus struct {
	...
	// Adaptive-throttle governor surface (spec 028 US1). All three are
	...
	// ungoverned (requested == effective); its state field arrives in US2, so
	// this slice always folds it empty. GovernorDebt/GovernorJobs are folded
